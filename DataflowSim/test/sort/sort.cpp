...
void Sort_Test::generateDfg()
{
    ...
    //dfg.addNode("tmp_j", "Load", { "to" }, &temp, temp_BaseAddr);
    //dfg.addNode("tmp_i", "Load", { "i" }, &temp, temp_BaseAddr);
    //dfg.addNode("tmp_j_k1", "Nop", { "to_cmp", "tmp_j" });
    //dfg.addNode("tmp_j_k2", "Nop", { "to_cmp", "tmp_j" });
    //dfg.addNode("tmp_i_k1", "Nop", { "to_cmp", "tmp_i" });
    //dfg.addNode("tmp_i_k2", "Nop", { "to_cmp", "tmp_i" });
    ...
    //dfg.addNode("tmp_j1", "Nop", { "tmp_j_k1" });
    //dfg.addNode("tmp_i1", "Nop", { "tmp_i_k1" });
    ...
    //dfg.addNode("tmp_j2", "Nop", { "tmp_j_k2" });
    //dfg.addNode("tmp_i2", "Nop", { "tmp_i_k2" });
    ...
    //dfg.addNodes2CtrlTree("loop_i", { "i", /*"i_lc",*/ /*"i_k1", "i_k2",*/ "m_m", "i_m_m", "to", "tmp_j", "tmp_i", "tmp_j_k1", "tmp_i_k1", "tmp_j_k2", "tmp_i_k2",/*"to_k1","to_k2",*/ "to_cmp",/*"to_cmp_k1","to_cmp_k2",*/ "br_merge_to" });
