...
// Backup
        ...
        //chan_partialSum_addr->get();
        //chan_partialSum_addr->value = chan_partialSum_addr->assign(chan_i_row_relay_loop_k) + chan_partialSum_addr->assign(lc_j->loopVar) + chan_partialSum_addr->assign(chan_jj_relay_loop_k);
