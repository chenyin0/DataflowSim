...
//
//    //*** Declare Lse
//    Lse* lse_ld_m1 = new Lse(16, 0, false, memSys, 1);  // Load M1
//    Lse* lse_ld_m2 = new Lse(16, 0, false, memSys, 1);  // Load M2
//    Lse* lse_ld_partialSum = new Lse(16, 0, false, memSys, 1);  // load partial sum
//    Lse* lse_st_partialSum = new Lse(16, 0, true, memSys, 8);  // Store back partial sum
//    lse_st_partialSum->noDownstream = 1;
//
//
//    //*** Declare Lc
...
//    ChanBase* lc_k_mux_outChan = new ChanBase(2, 0, 1);
//
//    ChanBase* chan_k_lc = new ChanBase(BRAM_BANK_DEPTH, 0, 1);
...
//
//    // loop kk
//    ChanBase* chan_jj_relay_loop_kk = new ChanBase(DGSF_INPUT_BUFF_SIZE, 0, 1);  // Relay channel in loop kk for chan_jj_lc
//    chan_jj_relay_loop_kk->keepMode = 1;
//
//    // loop i
//    ChanBase* chan_i_row = new ChanBase(DGSF_INPUT_BUFF_SIZE * BRAM_BANK_DEPTH, MUL, 1);
//    chan_i_row->keepMode = 1;
//
//    ChanBase* chan_jj_relay_loop_i = new ChanBase(DGSF_INPUT_BUFF_SIZE, 0, 1);  // Relay channel in loop i for chan_jj_lc
//    chan_jj_relay_loop_i->keepMode = 1;
//
//    ChanBase* chan_kk_relay_loop_i = new ChanBase(DGSF_INPUT_BUFF_SIZE, 0, 1);  // Relay channel in loop i for chan_kk_lc
//    chan_kk_relay_loop_i->keepMode = 1;
//
//    // loop k
//    ChanBase* chan_m1_addr = new ChanBase(2 * DGSF_INPUT_BUFF_SIZE, 2 * ADD, 8);
//
//    ChanBase* chan_k_row = new ChanBase(2 * DGSF_INPUT_BUFF_SIZE * BRAM_BANK_DEPTH, ADD + MUL, 8);
//    chan_k_row->keepMode = 1;
//
//    ChanBase* chan_m1_getData = new ChanBase(DGSF_INPUT_BUFF_SIZE * BRAM_BANK_DEPTH, 0, 8);
//    chan_m1_getData->keepMode = 1;
//
//    ChanBase* chan_jj_relay_loop_k = new ChanBase(DGSF_INPUT_BUFF_SIZE * BRAM_BANK_DEPTH, 0, 8);  // Relay channel in loop k for chan_jj_lc
//    chan_jj_relay_loop_k->keepMode = 1;
//
//    // loop j
//    ChanBase* chan_m2_addr = new ChanBase(2 * DGSF_INPUT_BUFF_SIZE * BRAM_BANK_DEPTH, 2 * ADD, 8);
//
//    ChanBase* chan_mul = new ChanBase(DGSF_INPUT_BUFF_SIZE * BRAM_BANK_DEPTH, MUL, 8);
//
//    ChanBase* chan_partialSum_addr = new ChanBase(2 * DGSF_INPUT_BUFF_SIZE * BRAM_BANK_DEPTH, 2 * ADD, 8);
//    /*ChanBase* chan_partialSum_getData = new ChanBase(16, 4);*/
//
//    ChanBase* chan_partialSum = new ChanBase(DGSF_INPUT_BUFF_SIZE, ADD, 8);
//
//
//    //*** Define interconnect
//    // Begin & end connect to the outer most loop
...
//
//    chan_partialSum_addr->addUpstream({ chan_i_row, lc_j->loopVar, chan_jj_relay_loop_k });
