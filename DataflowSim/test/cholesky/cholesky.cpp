...
void Cholesky_Test::graphPartition(ChanGraph& chanGraph, int partitionNum)
{
    ...
    case 7:
    {
        ...
        chanGraph.getNode("Chan_i_base_k_scatter_loop_j")->subgraphId = 1;
        chanGraph.getNode("Chan_j_base_shadow")->subgraphId = 1;
        chanGraph.getNode("Chan_Ajj_addr")->subgraphId = 2;
        chanGraph.getNode("Chan_Aij_addr")->subgraphId = 2;
        chanGraph.getNode("Chan_i_base_k_relay_loop_j")->subgraphId = 2;
        chanGraph.getNode("Lse_Ajj")->subgraphId = 3;
        chanGraph.getNode("Lse_Aij")->subgraphId = 3;
        chanGraph.getNode("Chan_Aij_shadow")->subgraphId = 3;

        chanGraph.getNode("Lc_k")->subgraphId = 4;
        chanGraph.getNode("Chan_j_base_shadow_scatter_loop_k")->subgraphId = 4;
        chanGraph.getNode("Chan_i_base_k_relay_loop_j_scatter_loop_k")->subgraphId = 4;
        chanGraph.getNode("Chan_Ajk_addr")->subgraphId = 4;
        chanGraph.getNode("Chan_Aik_addr")->subgraphId = 4;
